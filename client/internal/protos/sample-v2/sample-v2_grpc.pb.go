...
const (
	SampleV2Store_GetSampleV2_FullMethodName      = "/v2.sample.SampleV2Store/GetSampleV2"
	SampleV2Store_GetSampleAgainV2_FullMethodName = "/v2.sample.SampleV2Store/GetSampleAgainV2"
)
...
var SampleV2Store_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "v2.sample.SampleV2Store",
